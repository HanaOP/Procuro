        ...
        {loading ? <LoadingSpinner /> : (
          <div className="grid grid-cols-3 gap-3">
            <Link to="/supplier/rfqs"
              ...
              <p className={`font-mono text-2xl font-medium ${openRFQs.length > 0 ? 'text-amber-400' : 'text-slate-100'}`}>
                {openRFQs.length}
              </p>
            </Link>
            <Link to="/supplier/quotations" className="card hover:border-slate-600 transition-colors block">
